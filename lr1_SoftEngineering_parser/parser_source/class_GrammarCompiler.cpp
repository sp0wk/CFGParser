...
GrammarCompiler::GrammarCompiler()
{
	...
	///////////////////////// EXPRESSIONS ///////////////////////////////
		...
		postfix_dot_arrow = (s2= as_xpr("->") | '.') >> *_s >> (s1= primary_expr >> *_s >> !(postfix_func));	//access class member operator
		postfix_sqpars = as_xpr('[') >> *_s >> (s1= by_ref(expression)) >> *_s >> ']';							//array index
